 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "utez", wsdlLocation = "http://localhost:7777/Service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7777/Service?wsdl");
    ...
    public mx.edu.utez.soapclient.Service getServicePort() {
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public mx.edu.utez.soapclient.Service getServicePort(WebServiceFeature... features) {
